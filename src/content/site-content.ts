...
export const solutions: SolutionItem[] = [
  {
    ...
    summary: 'A secure copilot embedded into your workflows, documents, meetings, and knowledge systems.',
    problem: 'Teams waste time switching tools, searching documentation, and manually preparing updates for customers and leadership.',
    solution: 'We design enterprise copilots that connect to internal systems, summarize context, recommend next actions, and execute approved workflows.',
    impact: 'Faster decisions, shorter onboarding cycles, and measurable productivity gains for every team the copilot supports.',
    highlights: ['Role-specific prompts and guardrails', 'Knowledge retrieval with citations', 'Integration with CRM, docs, tickets, and BI'],
    icon: 'sparkles',
  },
  {
    slug: 'customer-support-ai-chatbot',
    title: 'Customer Support AI Chatbot (RAG)',
    summary: 'A floating support experience that answers complex customer questions using approved business knowledge.',
    problem: 'Traditional chatbots fail on nuanced product questions and create poor support experiences when information is incomplete or outdated.',
    solution: 'We build RAG-powered assistants backed by FAQs, policies, docs, and case studies so answers remain accurate, traceable, and current.',
    impact: 'Lower ticket volume, better response consistency, and 24/7 service without sacrificing trust.',
    highlights: ['Source-cited responses', 'Conversation memory', 'Escalation to human support or contact form'],
    icon: 'message',
  },
  {
    ...
    problem: 'Critical information is buried in drive folders, Notion pages, PDFs, and tickets, slowing down execution and increasing risk.',
    solution: 'We centralize enterprise knowledge with retrieval, permissions, and structured prompts so employees can ask natural questions and get trusted answers instantly.',
  ...
  },
  {
    ...
    summary: 'Multi-step operational automation combining APIs, rules, and AI-driven decision support.',
    problem: 'Manual approvals, repetitive ops tasks, and fragmented handoffs slow down revenue and service delivery.',
    solution: 'We orchestrate business workflows that move data, trigger approvals, generate content, and notify teams automatically.',
    impact: 'Reduced cycle times, fewer manual errors, and a better operating cadence across departments.',
    highlights: ['Human-in-the-loop approvals', 'Event-driven automations', 'Observability and auditability by design'],
    icon: 'zap',
  },
];
...
export const teamMembers: TeamMember[] = [
  ...
  {
    name: 'Enterprise Technology Advisor',
    role: 'Strategic Advisor',
    bio: 'An Australia-based consultant working with a large financial organization supports Vexa AI with enterprise architecture, governance, and strategic technology guidance.',
    linkedin: 'https://www.linkedin.com/',
    initials: 'CT',
  },
  {
