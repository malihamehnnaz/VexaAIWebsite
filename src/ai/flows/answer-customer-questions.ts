...
const getQuickIntentResponse = (
  ...
  const isCloudMigrationEstimate = containsAny(
    normalized,
    ['cloud migration', 'cloud migrering', 'migrering', 'migration']
  );

  if (isCloudMigrationEstimate) {
    return {
      answer:
        language === 'sv'
          ? '**Cloud Migration — Uppskattning**\n\nEtt typiskt cloud migration-projekt hos Vexa AI kostar **10 000–40 000 SEK** beroende pa scope.\n\nDetta inkluderar:\n• Cloud landing zone-setup (AWS / Azure / GCP)\n• Migrering av servrar, databaser och applikationer\n• CI/CD-pipeline och infrastruktur som kod\n• Sakerhets- och efterlevnadskontroller\n• Dokumentation och utbildning\n\n*Priset varierar baserat pa antal system, befintlig infrastruktur och onskad tidsplan.*'
          : '**Cloud Migration — Estimate**\n\nA typical cloud migration project with Vexa AI costs **10,000–40,000 SEK** depending on scope.\n\nThis includes:\n• Cloud landing zone setup (AWS / Azure / GCP)\n• Migration of servers, databases, and applications\n• CI/CD pipeline and infrastructure-as-code\n• Security and compliance controls\n• Documentation and training\n\n*Price varies based on number of systems, existing infrastructure, and desired timeline.*',
      suggestions:
        language === 'sv'
          ? ['AI-chatbot', 'Custom software', 'Kontakta oss', 'Visa case-studier']
          : ['AI chatbot', 'Custom software', 'Contact us', 'Show case studies'],
      nextQuestion:
        language === 'sv'
          ? 'Vill du boka ett kostnadsfritt konsultationssamtal for att diskutera ditt projekt?'
          : 'Would you like to book a free consultation call to discuss your project?',
    };
  }

  const isAiChatbotEstimate = containsAny(
    normalized,
    ['ai chatbot', 'ai-chatbot', 'chatbot', 'automation', 'ai bot', 'automatisering']
  );

  if (isAiChatbotEstimate) {
    return {
      answer:
        language === 'sv'
          ? '**AI-chatbot / Automation — Uppskattning**\n\nEtt AI-chatbot eller automationsprojekt hos Vexa AI kostar **5 000–60 000 SEK** beroende pa komplexitet.\n\nDetta inkluderar:\n• Kravanalys och flodeskartlaggning\n• AI-modellval och integration (OpenAI, Azure, Gemini)\n• Anpassad logik och kunskapsbas\n• Integrationer mot CRM / Slack / Teams / hemsida\n• Testning, lansering och utbildning\n\n*Enklare FAQ-bottar hamnar i den lagre delen; komplexa agentic-system i den hogre.*'
          : '**AI Chatbot / Automation — Estimate**\n\nAn AI chatbot or automation project with Vexa AI costs **5,000–60,000 SEK** depending on complexity.\n\nThis includes:\n• Requirements analysis and flow mapping\n• AI model selection and integration (OpenAI, Azure, Gemini)\n• Custom logic and knowledge base setup\n• Integrations with CRM / Slack / Teams / website\n• Testing, launch, and training\n\n*Simple FAQ bots land at the lower end; complex agentic systems at the higher end.*',
      suggestions:
        language === 'sv'
          ? ['Cloud migration', 'Custom software', 'Kontakta oss', 'Visa case-studier']
          : ['Cloud migration', 'Custom software', 'Contact us', 'Show case studies'],
      nextQuestion:
        language === 'sv'
          ? 'Vill du boka ett kostnadsfritt konsultationssamtal for att diskutera ditt projekt?'
          : 'Would you like to book a free consultation call to discuss your project?',
  ...
  const isCustomSoftwareEstimate = containsAny(
    normalized,
    ['custom software', 'skraddarsydd', 'bespoke', 'web app', 'mobile app', 'programvara', 'mjukvara', 'custom development']
  );

  if (isCustomSoftwareEstimate) {
    return {
      answer:
        language === 'sv'
          ? '**Custom Software — Uppskattning**\n\nSkraddarsydd mjukvaruutveckling hos Vexa AI kostar **5 000–100 000 SEK** beroende pa projektets storlek.\n\nDetta inkluderar:\n• UX/UI-design och prototyp\n• Full-stack webbutveckling (Next.js, React, Node.js)\n• Databas- och API-design\n• Moln-hosting och CI/CD\n• Testning, lansering och support\n\n*Mindre MVP-projekt hamnar i det lagre prisintervallet; enterprise-system i det hogre.*'
          : '**Custom Software — Estimate**\n\nCustom software development with Vexa AI costs **5,000–100,000 SEK** depending on project size.\n\nThis includes:\n• UX/UI design and prototype\n• Full-stack web development (Next.js, React, Node.js)\n• Database and API design\n• Cloud hosting and CI/CD\n• Testing, launch, and support\n\n*Smaller MVP projects land at the lower end; enterprise systems at the higher end.*',
      suggestions:
        language === 'sv'
          ? ['Cloud migration', 'AI-chatbot', 'Kontakta oss', 'Visa case-studier']
          : ['Cloud migration', 'AI chatbot', 'Contact us', 'Show case studies'],
      nextQuestion:
        language === 'sv'
          ? 'Vill du boka ett kostnadsfritt konsultationssamtal for att diskutera ditt projekt?'
          : 'Would you like to book a free consultation call to discuss your project?',
  ...
  const isDataAnalyticsEstimate = containsAny(
    normalized,
    ['data & analytics', 'data analytics', 'analytics', 'data platform', 'business intelligence', 'bi', 'dataanalys', 'dataplattform']
  );

  if (isDataAnalyticsEstimate) {
    return {
      answer:
        language === 'sv'
          ? '**Data & Analytics — Uppskattning**\n\nEtt data- och analysprojekt hos Vexa AI kostar **8 000–50 000 SEK** beroende pa datakallor och komplexitet.\n\nDetta inkluderar:\n• Datakartlaggning och arkitekturdesign\n• ETL-pipelines och dataintegrationer\n• Dashboard och rapportering (Power BI / Looker / custom)\n• AI/ML-modeller for insikter och prognoser\n• Utbildning och dokumentation\n\n*Enklare dashboards hamnar i den lagre delen; avancerade ML-pipelines i den hogre.*'
          : '**Data & Analytics — Estimate**\n\nA data and analytics project with Vexa AI costs **8,000–50,000 SEK** depending on data sources and complexity.\n\nThis includes:\n• Data mapping and architecture design\n• ETL pipelines and data integrations\n• Dashboard and reporting (Power BI / Looker / custom)\n• AI/ML models for insights and forecasting\n• Training and documentation\n\n*Simpler dashboards land at the lower end; advanced ML pipelines at the higher end.*',
      suggestions:
        language === 'sv'
          ? ['Cloud migration', 'AI-chatbot', 'Kontakta oss', 'Visa case-studier']
          : ['Cloud migration', 'AI chatbot', 'Contact us', 'Show case studies'],
