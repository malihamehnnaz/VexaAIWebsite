...
export const siteCopy = {
  en: {
    ...
    form: {
      ...
      available: 'Tell us when you are available (Optional)',
      availablePlaceholder: 'Select a date',
      availableTime: 'Preferred time slot (Sweden time)',
      ...
      validationAvailableTime: 'Please choose a time slot for your selected date.',
    },
    blog: {
      eyebrow: 'Insights',
  ...
  sv: {
    ...
    form: {
      ...
      available: 'Berätta när du är tillgänglig (valfritt)',
      availablePlaceholder: 'Välj ett datum',
      availableTime: 'Önskad tid (Sverige)',
      timePlaceholder: 'Välj en tid',
      ...
      validationAvailableTime: 'Vänligen välj en tid för det valda datumet.',
    },
    blog: {
      eyebrow: 'Insikter',
