...
--
-- One row per (page_id, metric, date) — the UNIQUE constraint is what makes
-- repeated syncs idempotent (upserted via onConflict: 'page_id,metric,date'
-- in recordPageInsight), not an append-only log like instagram_insights.
--
